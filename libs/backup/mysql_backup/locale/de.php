...
$GONX["deleteconfirm"] = ' Sie wollen diese Datei l�schen ?\nKlicken Sie OK zur Best�tigung.';
...
// Home page content
$GONX['homepage'] = "<b>".$GONX["title"]."</b> ist eine Komplettl�sung f�r MySQL Datenbank-Backup and Wiederherstellung.<br/>
			...
			<li>Sie k�nnen <a href=\"?go=list\" class=tab-g>eine Liste</a> vorhandener Datenbank-Backups aufrufen.</li>
			</ul>
			Vergessen Sie nicht das \"Backup\"-Verzeichnis zu sch�tzen. Besser ist es ein Nicht-Web-Verzeichnis zu benutzen , wo das System eine Sichere Kopie des Backups ablegen kann..
			<br/><br/>
...
$GONX["autherror"] = " Bitte geben Sie einen Benutzernamen und ein Passwort ein, um in den gesch�tzten Bereich zu gelangen";

$GONX["home"] = "Home";
$GONX["create"] = " Backup erzeugen";
$GONX["list"] = "Liste/Backup importieren";
$GONX["optimize"] = "Optimieren";
$GONX["monitor"] = "�berwachen";
...
$GONX["selectbackupfile"] = "&nbsp;&nbsp;&nbsp;&nbsp;W�hlen Sie aus den vorhandenen Backup-Dateien zum Import";
$GONX["importbackupfile"] = "Oder laden Sie es von hier hoch";
$GONX["delete"] = "Delete";
$GONX["nobckupfile"] = "keine Backup-Dateien verf�gbar. Klicken Sie <a href=\"?go=create\" class=tab-g>Backup erzeugen</a> um ein Backup Ihrer Datenbank herzustellen";
...
$GONX["totalbackupsize"] = "Gesamtgr�sse des  Backupverzeichnisses ";
$GONX["chgdisplayorder"] = "Reihenfolge der Anzeige ver�ndern";
$GONX["next"] = "N�chstes";
...
$GONX["tablesmenuhelp"] = "<u>Hilfe</u>  : Wenn Sie <label>Labels</label> sehen, wurde etwas in der Tabelle ver�ndert.";
$GONX["backupholedb"] = "Klicken Sie hier, um einen Backup der ganzen Datenbank zu erzeugen :";
$GONX["selecttables"] = "Oder w�hlen Sie die Tabellen, von denen Sie ein Backup herstellen wollen, hier :";
